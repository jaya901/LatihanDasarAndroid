...
//        listView.setOnItemClickListener(this);
    ...
    private void showEmployee(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                ...
                new String[]{Konfigurasi.TAG_ID,Konfigurasi.TAG_NAMA,Konfigurasi.TAG_NOHP,Konfigurasi.TAG_ALAMAT, Konfigurasi.TAG_JENISKELAMIN},
                new int[]{R.id.tvid, R.id.nama, R.id.nohp, R.id.alamat, R.id.jk});
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute(){
                super.onPreExecute();
                loading = ProgressDialog.show(TampilActivity.this, "Mengambil Data",
